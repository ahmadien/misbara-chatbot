...
export const Sidebar = ({
  ...
  return (
    <div className="hidden md:flex flex-col w-64 text-white border-r shadow-lg md:static" style={{background:'#0d0d0d',borderColor:'#e50914'}}>
      <div className="flex items-center justify-center p-4 border-b border-red-600">
        <button
